...
Chess-Sensei stores all game data, player metrics, and analysis results
...
Chess-Sensei uses platform-appropriate user data directories:

#### Windows

```text
%APPDATA%\Chess-Sensei\
C:\Users\[username]\AppData\Roaming\Chess-Sensei\
```

#### macOS

```text
~/Library/Application Support/Chess-Sensei/
/Users/[username]/Library/Application Support/Chess-Sensei/
```

#### Linux

```text
~/.local/share/chess-sensei/
/home/[username]/.local/share/chess-sensei/
```
...
- Useful when using Chess-Sensei on multiple computers
...
When Chess-Sensei updates data formats:
...
Chess-Sensei does **not** send any data to external servers unless explicitly
enabled by the user.
