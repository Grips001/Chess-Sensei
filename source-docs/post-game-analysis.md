...
After completing an **Exam Mode** game, Chess-Sensei provides a comprehensive
...
Based on the analysis, Chess-Sensei provides **actionable training advice**.
...
- **Export Game Data (JSON)**
  ...
  - Can be imported back into Chess-Sensei
...
- Share game link with other Chess-Sensei users
...
Chess-Sensei can **track positions you struggled with** and present them again
later:
